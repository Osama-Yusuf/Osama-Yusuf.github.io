...
add_list.addEventListener("click", () => {
  ...
  rmv_list.innerHTML = '<i class="fas fa-times-circle"></i>';
  // rmv_list.innerHTML = '<i class="far fa-times-circle"></i>';
  // rmv_list.innerHTML = '<i class="fas fa-times"></i>';
  rmv_list.classList.add("rmv_list");
  div.appendChild(rmv_list);

  rmv_list.addEventListener("click", () => {
    de_cont.removeChild(div)
    de_cont.removeChild(seperate)
  })
  /* -------------------------------------------------------------------------- */
  ...
  if (body.classList.contains("dark")) {
    ...
    form.classList.toggle("frmsh");

    rmv_list.classList.toggle("rmv_list");
    rmv_list.classList.toggle("rmv_list_dark");
  }
